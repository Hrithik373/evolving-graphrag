...
CREATE PROPERTY Chunk.embedding IF NOT EXISTS LIST OF FLOAT;
...
CREATE PROPERTY Entity.embedding IF NOT EXISTS LIST OF FLOAT;
...
CREATE PROPERTY Community.embedding IF NOT EXISTS LIST OF FLOAT;
...
CREATE PROPERTY CostRecord.wall_ms IF NOT EXISTS FLOAT;
CREATE PROPERTY CostRecord.usd IF NOT EXISTS FLOAT;
...
CREATE PROPERTY MENTIONS.confidence IF NOT EXISTS FLOAT;
...
CREATE PROPERTY RELATES_TO.weight IF NOT EXISTS FLOAT;
